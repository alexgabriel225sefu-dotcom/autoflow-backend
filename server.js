...
const publicPages = ['access','privacy','terms','intro-epic','app','demo','try','videos','screen','screens','tiktok-demo','video-maker','video-gen','bot-setup','setup-guide','configurator','configurator-forex','deploy','ad','results','profile','flex','flex2','flex3','heygen','mt5-sim','trading-journal','affiliate','affiliate-terms','thank-you','chart','free','promo','guide'];
...
app.post('/api/railway-deploy', async (req, res) => {
  ...
  try {
    ...
    // 1b) Fetch environment ID separately (Railway doesn't return it inline)
