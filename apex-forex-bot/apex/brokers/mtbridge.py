"""MetaTrader bridge connector — drive any MT5 broker.

The EA POSTs a plain-text snapshot to /api/mt/sync and receives pending
...
Wire format (request, one item per line):
    ...
    ACK=42|FILLED|1.08501
    CANDLE=1718000000|o|h|l|c|v

Response:
    OK
    CMD=42|OPEN|BUY|0.12|1.08350|1.08800
    CMD=43|CLOSE
"""
import time
import threading
