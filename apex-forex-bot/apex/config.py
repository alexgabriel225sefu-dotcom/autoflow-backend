...
TAKE_PROFIT_PIPS = float(os.getenv("TAKE_PROFIT_PIPS") or 30)
MIN_CONFIDENCE = int(os.getenv("MIN_CONFIDENCE") or 65)
LEVERAGE = float(os.getenv("LEVERAGE") or 30)
MARGIN_CAP = float(os.getenv("MARGIN_CAP") or 0.5)
MAX_SPREAD_PIPS = float(os.getenv("MAX_SPREAD_PIPS") or 3.0)
