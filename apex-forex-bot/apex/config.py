...
STOP_LOSS_PIPS = float(os.getenv("STOP_LOSS_PIPS") or 25)   # tuning r4: sl25 winner (EUR+AUD)
TAKE_PROFIT_PIPS = float(os.getenv("TAKE_PROFIT_PIPS") or 75)  # tuning r4: R:R 3:1 (AUD +1.46%, EUR breakeven)
